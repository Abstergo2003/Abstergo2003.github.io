function zad4() {
    ...
    if ((y2 - y1) >= 0) {
        if ((x2 - x1) > 0) {
            ...
            output4.innerHTML += "A12 = czwartak <br>";
            output4.innerHTML += "A12 = ";
            output4.innerHTML += A12;
            output4.innerHTML += "<br>"
            output4.innerHTML += "A21 = PI + czwartak <br>";
            ...
            output4.innerHTML += "A12 = PI - czwartak <br>";
            output4.innerHTML += "A12 = ";
            output4.innerHTML += A12;
            output4.innerHTML += "<br>"
            output4.innerHTML += "A21 = 2PI - czwartak <br>";
            output4.innerHTML += "A21 = ";
            output4.innerHTML += A21;
            output4.innerHTML += "<br>"
        }
        ...
        if ((x2 - x1) < 0) {
            ...
            output4.innerHTML += A12;
            output4.innerHTML += "<br>"
            output4.innerHTML += "A21 = czwartak <br>";
            output4.innerHTML += "A21 = ";
            output4.innerHTML += A21;
            output4.innerHTML += "<br>"
        } else {
            ...
            output4.innerHTML += "A12 =2PI - czwartak <br>";
            output4.innerHTML += "A12 = ";
            output4.innerHTML += A12;
            output4.innerHTML += "<br>"
            output4.innerHTML += "A21 = PI - czwartak <br>";
    ...
    output4.innerHTML += "d12 = Math.sqrt((x2-x1)^2 + (y2-y1)^2)";
    output4.innerHTML += "<br>"
    output4.innerHTML += d12;
    output4.innerHTML += "<br>"
    console.log(d12);
    d1p = (d12 / Math.sin(alpha + beta)) * Math.sin(beta);
    output4.innerHTML += "d1p = (d12 / Math.sin(alpha + beta)) * Math.sin(beta)"
    output4.innerHTML += "<br>"
    output4.innerHTML += d1p;
    output4.innerHTML += "<br>"
    d2p = (d12 / Math.sin(alpha + beta)) * Math.sin(alpha);
    output4.innerHTML += "d2p = (d12 / Math.sin(alpha + beta)) * Math.sin(alpha)"
    output4.innerHTML += "<br>"
    ...
    console.log(d2p);
    A1p = A12 + alpha;
    output4.innerHTML += "A1p = A12 + alpha";
    output4.innerHTML += "<br>";
    output4.innerHTML += A1p;
    output4.innerHTML += "<br>";
    dx = d1p * Math.cos(A1p);
    output4.innerHTML += "dx = d1p * Math.cos(A1p)";
    output4.innerHTML += "<br>";
    output4.innerHTML += dx;
    output4.innerHTML += "<br>";
    dy = d1p * Math.sin(A1p);
    output4.innerHTML += "dy = d1p * Math.sin(A1p)";
    output4.innerHTML += "<br>";
    output4.innerHTML += dy;
    output4.innerHTML += "<br>";
    xp = x1 + dx;
    output4.innerHTML += "xp = x1 + dx";
    output4.innerHTML += "<br>";
    output4.innerHTML += xp;
    output4.innerHTML += "<br>";
    yp = y1 + dy;
    output4.innerHTML += "yp = y1 + dy";
    output4.innerHTML += "<br>";
